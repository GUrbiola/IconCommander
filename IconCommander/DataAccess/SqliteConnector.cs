...
FROM
    IconFiles Ifil
    INNER JOIN Icons I ON Ifil.Icon = I.Id
    INNER JOIN IconTags It ON I.Id = It.Icon
WHERE
    Ifil.Id = @IconFileId
ORDER BY It.Tag
";
        ...
        {
            string sql = "SELECT Icon FROM IconFiles WHERE Id = @IconFileId";
        ...
        {
            string sql = "DELETE FROM IconTags WHERE Icon = @Icon AND Tag = @Tag";
